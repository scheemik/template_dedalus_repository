...
###############################################################################
# Write out to file if rank==0

if (rank==0):
    # Name of log file
    logfile = '../' + NAME + '/outputs/' + RUN_NAME + '/' + RUN_NAME + '_Log.txt'
    # Record any old data in log file
    with open(logfile, 'r') as old_file: old_logs = old_file.read()
